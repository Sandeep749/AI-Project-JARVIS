...
################################################################################
## Form generated from reading UI file 'ui_mainuRwDHD.ui'
##
...
"}")
        self.Btn_audio_mode = QPushButton(self.frame_controls)
        self.Btn_audio_mode.setObjectName(u"Btn_audio_mode")
        self.Btn_audio_mode.setGeometry(QRect(1120, 10, 91, 31))
        self.Btn_audio_mode.setFont(font)
        self.Btn_audio_mode.setCursor(QCursor(Qt.PointingHandCursor))
        self.Btn_audio_mode.setStyleSheet(u"QPushButton {\n"
"	color: rgb(85, 170, 255);;\n"
"	background-color: rgb(0, 0, 0);\n"
"	border: 1px solid;\n"
"	border-color: rgb(85, 170, 255);\n"
...
"}")
        ...
        self.Btn_text_mode.setObjectName(u"Btn_text_mode")
...
"}")
        ...
        self.label_6 = QLabel(self.frame_main_content)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(350, 20, 231, 131))
        self.label_6.setPixmap(QPixmap(u"gif/43.gif"))
        self.label_6.setScaledContents(True)
        self.label_44 = QLabel(self.frame_main_content)
        self.label_44.setObjectName(u"label_44")
        self.label_44.setGeometry(QRect(1260, 500, 41, 71))
        self.label_44.setPixmap(QPixmap(u"gif/44.gif"))
        self.label_44.setScaledContents(True)
        self.label_44.setIndent(-1)
        self.label_4 = QLabel(self.frame_main_content)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(180, 130, 141, 131))
        self.label_4.setPixmap(QPixmap(u"gif/24.gif"))
        self.label_4.setScaledContents(True)
        self.textDisplayConversation = QTextBrowser(self.frame_main_content)
        self.textDisplayConversation.setObjectName(u"textDisplayConversation")
        self.textDisplayConversation.setGeometry(QRect(1020, 180, 291, 381))
        self.textDisplayConversation.setFont(font)
        self.textDisplayConversation.setStyleSheet(u"color: rgb(85, 170, 255);\n"
"border:1px solid;\n"
"border-color: rgb(85, 170, 255);\n"
"background-color: rgb(0, 0, 0);")
        self.globe = QLabel(self.frame_main_content)
        self.globe.setObjectName(u"globe")
        self.globe.setGeometry(QRect(970, 20, 161, 91))
        self.globe.setMinimumSize(QSize(0, 0))
        self.globe.setMaximumSize(QSize(16777215, 16777215))
        self.globe.setPixmap(QPixmap(u"gif/17.gif"))
        self.globe.setScaledContents(True)
        self.label_7 = QLabel(self.frame_main_content)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(1020, 160, 81, 21))
        self.label_7.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(85, 170, 255);")
        self.time = QLabel(self.frame_main_content)
        self.time.setObjectName(u"time")
        self.time.setGeometry(QRect(1120, 30, 161, 31))
        font2 = QFont()
        font2.setPointSize(30)
        self.time.setFont(font2)
        self.time.setStyleSheet(u"color: rgb(85, 170, 255);")
        self.date = QLabel(self.frame_main_content)
        self.date.setObjectName(u"date")
        self.date.setGeometry(QRect(1120, 70, 111, 21))
        self.date.setFont(font)
        self.date.setStyleSheet(u"color: rgb(85, 170, 255);")
        self.label_33 = QLabel(self.frame_main_content)
        self.label_33.setObjectName(u"label_33")
        self.label_33.setGeometry(QRect(30, 280, 281, 151))
        self.label_33.setPixmap(QPixmap(u"gif/33.gif"))
        self.label_33.setScaledContents(True)
        self.label_31 = QLabel(self.frame_main_content)
        self.label_31.setObjectName(u"label_31")
        self.label_31.setGeometry(QRect(10, 10, 231, 151))
        self.label_31.setPixmap(QPixmap(u"gif/31.gif"))
        self.label_31.setScaledContents(True)
        self.label_23 = QLabel(self.frame_main_content)
        self.label_23.setObjectName(u"label_23")
        self.label_23.setGeometry(QRect(820, 250, 181, 301))
        self.label_23.setPixmap(QPixmap(u"gif/23.gif"))
        self.label_23.setScaledContents(True)
        self.label_22 = QLabel(self.frame_main_content)
        self.label_22.setObjectName(u"label_22")
        self.label_22.setGeometry(QRect(860, 10, 121, 121))
        self.label_22.setPixmap(QPixmap(u"gif/22.gif"))
        self.label_22.setScaledContents(True)
        self.label = QLabel(self.frame_main_content)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(670, 190, 47, 13))
        self.label_nice = QLabel(self.frame_main_content)
        self.label_nice.setObjectName(u"label_nice")
        self.label_nice.setGeometry(QRect(340, 180, 361, 281))
        self.label_nice.setPixmap(QPixmap(u"gif/nice.gif"))
        self.label_nice.setScaledContents(True)
        self.label_6.raise_()
        self.label_4.raise_()
        self.textDisplayConversation.raise_()
...
"border:0px solid;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.App_name.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:10pt; color:#ffffff;\">AI Powered Personal Assistant</span></p></body></html>", None))
        ...
        self.Btn_text_mode.setText(QCoreApplication.translate("MainWindow", u"Text Mode", None))
